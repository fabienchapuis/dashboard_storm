 ...
 */
final class Version20190712093921 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C0D0D58663C02CD4 ON saison');
        $this->addSql('ALTER TABLE saison DROP evenements_id, DROP user_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, lieux VARCHAR(45) NOT NULL COLLATE utf8mb4_unicode_ci, nbenfants INT DEFAULT NULL, distance INT DEFAULT NULL, precense VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, evenement_id INT NOT NULL, placedispo INT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_5FB6DEC7FD02F13 (evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE saison ADD evenements_id INT DEFAULT NULL, ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE saison ADD CONSTRAINT FK_C0D0D58663C02CD4 FOREIGN KEY (evenements_id) REFERENCES evenement (id)');
        $this->addSql('CREATE INDEX IDX_C0D0D58663C02CD4 ON saison (evenements_id)');
    }
}
